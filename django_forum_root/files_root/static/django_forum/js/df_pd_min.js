(function(){function EditPost(){console.log("edit post function")
$('.update-form-text').val($('#textarea').html())
$('#title_input').val($('#post_title').html())
$('.post-edit-div').show();tinymce.editors[0].show();$('#title-div').hide();$('#text-errors').hide();$('#textarea').hide();$('#modify-post-btns').hide();}
function HideEditPost(){tinymce.editors[0].hide();$('.update-form-text').hide()
$('.post-edit-div').hide()
...
return cookieValue;}
function showUpdateComment(id){$("#comment-textarea-"+id).val($('#comment-text-'+id).text().trim())
...
$("label[for='subscribed_cb']").text(text);});}).call(this);