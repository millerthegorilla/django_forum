...
class ForumProfile(profile_models.Profile):
    ...
    city: db_models.CharField = db_models.CharField('city', max_length=30, blank=True, default='')
    country: db_models.CharField = db_models.CharField('country', max_length=30, blank=True, default='')
